        ...
        <div className="container-fluid">
          <div className="menu-caro">
            <div className="row">
              ...
              {/* Nav Icons - forced horizontal with flexbox */}
              <div className="col-lg-8">
                ...
                >
                  ...
                  <div className="link-item" style={{ flex: "1", textAlign: "center" }}>
                  ...
                  <div className="link-item" style={{ flex: "1", textAlign: "center" }}>
                    <a href="blog.html" title="">
                      <i className="">
                        <svg className="feather feather-layout" strokeLinejoin="round" strokeLinecap="round" strokeWidth="2" stroke="currentColor" fill="none" viewBox="0 0 24 24" height="24" width="24" xmlns="http://www.w3.org/2000/svg">
